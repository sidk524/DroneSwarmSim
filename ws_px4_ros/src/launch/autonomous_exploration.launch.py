...
def generate_launch_description():
    ...
    lidar_points_bridge = Node(
        ...
        output='screen',
        arguments=[
            '/world/walls/model/x500_lidar_3d_0/link/lidar_link/sensor/gpu_lidar_3d/scan/points'
    ...
    imu_data_bridge = Node(
        ...
        output='screen',
        arguments=[
            '/world/walls/model/x500_lidar_3d_0/link/base_link/sensor/imu_sensor/imu'
