...
HeadingPlanner::HeadingPlanner() : rclcpp::Node("heading_planner") {
  frontier_pub_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/heading_planner/frontier", 20);
  visib_pub_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/heading_planner/visib", 20);
  box_pub_ = this->create_publisher<visualization_msgs::msg::Marker>("/heading_planner/box", 20);

  this->declare_parameter("heading_planner/yaw_diff", -1.0);
  this->declare_parameter("heading_planner/lambda1", -1.0);
  this->declare_parameter("heading_planner/lambda2", -1.0);
  this->declare_parameter("heading_planner/half_vert_num", -1);
  this->declare_parameter("heading_planner/max_yaw_rate", -1.0);
  this->declare_parameter("heading_planner/w", -1.0);
  this->declare_parameter("heading_planner/weight_type", -1);


  this->get_parameter("heading_planner/yaw_diff", yaw_diff_);
  this->get_parameter("heading_planner/lambda1", lambda1_);
  this->get_parameter("heading_planner/lambda2", lambda2_);
  this->get_parameter("heading_planner/half_vert_num", half_vert_num_);
  this->get_parameter("heading_planner/max_yaw_rate", max_yaw_rate_);
  this->get_parameter("heading_planner/w", w_);
  this->get_parameter("heading_planner/weight_type", weight_type_);
