...
FrontierFinder::FrontierFinder(const EDTEnvironment::Ptr& edt) : rclcpp::Node("frontier_finder_node") {
  this->edt_env_ = edt;
  ...
  this->declare_parameter("frontier/cluster_min", -1);
  this->declare_parameter("frontier/cluster_size_xy", -1.0);
  this->declare_parameter("frontier/cluster_size_z", -1.0);
  this->declare_parameter("frontier/min_candidate_dist", -1.0);
  this->declare_parameter("frontier/min_candidate_clearance", -1.0);
  this->declare_parameter("frontier/candidate_dphi", -1.0);
  this->declare_parameter("frontier/candidate_rmax", -1.0);
  this->declare_parameter("frontier/candidate_rmin", -1.0);
  this->declare_parameter("frontier/candidate_rnum", -1);
  this->declare_parameter("frontier/down_sample", -1);
  this->declare_parameter("frontier/min_visib_num", -1);
  this->declare_parameter("frontier/min_view_finish_fraction", -1.0);


  this->get_parameter("frontier/cluster_min", cluster_min_);
  this->get_parameter("frontier/cluster_size_xy", cluster_size_xy_);
  this->get_parameter("frontier/cluster_size_z", cluster_size_z_);
  this->get_parameter("frontier/min_candidate_dist", min_candidate_dist_);
  this->get_parameter("frontier/min_candidate_clearance", min_candidate_clearance_);
  this->get_parameter("frontier/candidate_dphi", candidate_dphi_);
  this->get_parameter("frontier/candidate_rmax", candidate_rmax_);
  this->get_parameter("frontier/candidate_rmin", candidate_rmin_);
  this->get_parameter("frontier/candidate_rnum", candidate_rnum_);
  this->get_parameter("frontier/down_sample", down_sample_);
  this->get_parameter("frontier/min_visib_num", min_visib_num_);
  this->get_parameter("frontier/min_view_finish_fraction", min_view_finish_fraction_);
