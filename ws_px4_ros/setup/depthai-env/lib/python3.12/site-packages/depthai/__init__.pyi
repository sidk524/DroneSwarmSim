...
class AlignConfig(Buffer):
    """AlignConfig configuration structure"""
    staticDepthPlane: int
    def __init__(self) -> None:
        """__init__(self: depthai.AlignConfig) -> None"""

class AlignProperties:
...
class CBACalibrationHandler:
    ...
    def getCameraIntrinsics(self, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CBACalibrationHandler, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa06972b6b0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581f31b0>, keepAspectRatio: bool = True) -> list[list[float]]

        2. getCameraIntrinsics(self: depthai.CBACalibrationHandler, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581f1c30>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581fd5b0>, keepAspectRatio: bool = True) -> list[list[float]]

        3. getCameraIntrinsics(self: depthai.CBACalibrationHandler, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0582123f0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581aad70>, keepAspectRatio: bool = True) -> list[list[float]]
        """
    @overload
...
class CalibrationHandler:
    ...
    def getCameraIntrinsics(self, cameraId: CameraBoardSocket, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa058211f30>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0580b2ef0>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        2. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581f2f30>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0580b3030>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        3. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581b9170>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0xffa0581bb730>, keepAspectRatio: bool = True) -> list[list[float]]
...
class DatatypeEnum:
    ...
    AlignConfig: ClassVar[DatatypeEnum] = ...
...
class DeviceBase:
    ...
    def performHealthCheck(deviceInfo: DeviceInfo, config: HealthCheckConfig = ...) -> HealthCheckMetrics:
        """performHealthCheck(deviceInfo: depthai.DeviceInfo, config: depthai.HealthCheckConfig = <depthai.HealthCheckConfig object at 0xffa058222bb0>) -> depthai.HealthCheckMetrics
    ...
    def setExternalStrobeEnable(self, enable: bool) -> None:
        """setExternalStrobeEnable(*args, **kwargs)
        Overloaded function.

        1. setExternalStrobeEnable(self: depthai.DeviceBase, enable: bool) -> None
        ...
        2. setExternalStrobeEnable(self: depthai.DeviceBase, exposureMasterSocket: depthai.CameraBoardSocket) -> None

        Set which camera will control the external strobe exposure. Automaticaly enables
        external strobe. External strobe signal is low for the duration of exposure, and
        high for the rest of the frame.

        Parameter ``exposureMasterSocket``:
            CameraBoardSocket of the camera which will control the external strobe
            exposure
        """
    @overload
    def setExternalStrobeEnable(self, exposureMasterSocket: CameraBoardSocket) -> None:
        """setExternalStrobeEnable(*args, **kwargs)
        Overloaded function.
...
class EncodedFrame(Buffer, ProtoSerializable):
    class FrameType:
        """
...
class Extrinsics:
    ...
    def getTranslationVector(self, useSpecTranslation: bool = ..., unit: LengthUnit = ...) -> list[float]:
        ...
        """
    def hasCompatibleCoordinateSystem(self, to: Extrinsics) -> bool:
        """hasCompatibleCoordinateSystem(self: depthai.Extrinsics, to: depthai.Extrinsics) -> bool
...
class IMUData(Buffer, ProtoSerializable):
...
class ImgAnnotations(Buffer, ProtoSerializable):
...
class ImgDetections(Buffer, ProtoSerializable, Transformable):
    ...
    def getCvSegmentationMaskByIndex(self, index: int) -> numpy.ndarray | None:
        ...
        Parameter ``allocator``:
            ...
            memory management; nullptr uses OpenCV’s default.
        """
    def getMaskData(self) -> object:
        """getMaskData(self: depthai.ImgDetections) -> object
...
class ImgFrame(Buffer, ProtoSerializable):
    class Fsync:
        """Members:
...
class InputQueue:
    ...
    def trySend(self, msg: ADatatype) -> bool:
        """trySend(self: depthai.InputQueue, msg: depthai.ADatatype) -> bool
...
class NNArchive:
    ...
    def __init__(self, archivePath: os.PathLike, compression: NNArchiveEntry.Compression = ...) -> None:
        ...
        2. __init__(self: depthai.NNArchive, archivePath: os.PathLike, options: depthai.NNArchiveOptions = <depthai.NNArchiveOptions object at 0xffa0580881b0>) -> None
    ...
    def getModelType(self) -> ModelType:
        ...
        """
    def getOtherModelFormat(self) -> object:
        """getOtherModelFormat(self: depthai.NNArchive) -> object
...
class NNData(Buffer, ProtoSerializable):
...
class Node:
    ...
    class Input(MessageQueue):
        ...
        def __init__(self, parent: Node, name: str = ..., group: str = ..., blocking: bool = ..., queueSize: int = ..., types: list[Node.DatatypeHierarchy] = ..., waitForMessage: bool = ...) -> None:
            """__init__(self: depthai.Node.Input, parent: depthai.Node, name: str = '', group: str = '', blocking: bool = True, queueSize: int = 3, types: list[depthai.Node.DatatypeHierarchy] = [<depthai.Node.DatatypeHierarchy object at 0xffa05076a430>], waitForMessage: bool = False) -> None"""
    ...
    class Output:
        ...
        def __init__(self, parent: Node, name: str = ..., group: str = ..., possibleDatatypes: list[Node.DatatypeHierarchy] = ...) -> None:
            """__init__(self: depthai.Node.Output, parent: depthai.Node, name: str = '', group: str = '', possibleDatatypes: list[depthai.Node.DatatypeHierarchy] = [<depthai.Node.DatatypeHierarchy object at 0xffa05076a7b0>]) -> None"""
...
class PointCloudData(Buffer, ProtoSerializable, Transformable):
...
class ProtoSerializable:
    ...
    def load(self, path: os.PathLike) -> None:
        """load(self: depthai.ProtoSerializable, path: os.PathLike) -> None"""
    def save(self, path: os.PathLike, metadataOnly: bool = ...) -> None:
        """save(self: depthai.ProtoSerializable, path: os.PathLike, metadataOnly: bool = False) -> None"""
...
class RGBDData(Buffer, ProtoSerializable):
...
class SegmentationMask(Buffer, ProtoSerializable, Transformable):
...
class SpatialImgDetections(Buffer, ProtoSerializable, Transformable):
    ...
    def getCvSegmentationMaskByIndex(self, index: int) -> numpy.ndarray | None:
        ...
        """
    def getMaskData(self) -> object:
        """getMaskData(self: depthai.SpatialImgDetections) -> object
...
class SpatialKeypoint:
    ...
    def __init__(self) -> None:
        ...
        2. __init__(self: depthai.SpatialKeypoint, imageCoordinates: depthai.Point3f, spatialCoordinates: depthai.Point3f = <depthai.Point3f object at 0xffa0697417f0>, confidence: float = -1.0, label: int = 0, labelName: str = '') -> None

        3. __init__(self: depthai.SpatialKeypoint, imageCoordinates: depthai.Point2f, spatialCoordinates: depthai.Point3f = <depthai.Point3f object at 0xffa0507ca5b0>, confidence: float = 0.0, label: int = 0, labelName: str = '') -> None
...
class ToFStereoFusionConfig:
    confidenceThreshold: float
    def __init__(self) -> None:
        """__init__(self: depthai.ToFStereoFusionConfig) -> None"""
    def setConfidenceThreshold(self, threshold: float) -> ToFStereoFusionConfig:
        """setConfidenceThreshold(self: depthai.ToFStereoFusionConfig, threshold: float) -> depthai.ToFStereoFusionConfig"""
